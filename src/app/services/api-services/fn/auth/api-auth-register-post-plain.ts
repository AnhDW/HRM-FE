...
export function apiAuthRegisterPost$Plain(http: HttpClient, rootUrl: string, params: ApiAuthRegisterPost$Plain$Params, context?: HttpContext): Observable<StrictHttpResponse<ResponseDto>> {
